    ...
    return _then(_value.copyWith(
      ...
      sortBy: sortBy == freezed
          ...
          : sortBy // ignore: cast_nullable_to_non_nullable
              as String?,
      productsIds: productsIds == freezed
          ? _value.productsIds
...
class _$_ProductFilterModel implements _ProductFilterModel {
  ...
  @override
  String toString() {
    return 'ProductFilterModel(paginationModel: $paginationModel, categoryId: $categoryId, sortBy: $sortBy, productsIds: $productsIds)';
  }
...
abstract class _ProductFilterModel implements ProductFilterModel {
  factory _ProductFilterModel(
      ...
      String? categoryId,
      String? sortBy,
      List<String>? productsIds}) = _$_ProductFilterModel;
